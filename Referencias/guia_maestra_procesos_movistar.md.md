...
- **Caso de Uso - Valeria Mendoza (El hito de consumo):** Valeria es una diseñadora que viaja constantemente por trabajo entre Lima, Arequipa y Trujillo. Cuenta con un plan móvil con un tope de 20 GB de datos. El subproceso de comportamiento detecta que, de manera recurrente, Valeria agota sus gigas el día 18 del mes y gasta soles adicionales adquiriendo paquetes de datos individuales para compartir internet (hotspot) a su laptop.
