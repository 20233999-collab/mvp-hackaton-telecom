...
* **[`ROLES_AND_PERSONAS.md`](file:///home/laptop/Documentos/mvp-hackaton-telecom/agents/ROLES_AND_PERSONAS.md):** Fichas detalladas de las personas del ecosistema (Miguel Mendoza, Carlos Alvarado, Ana Morales, Jorge Ramos y Miguel).
...
1. **Fase 1 (Reto 2):** Venta Consultiva NBO/CVM a Miguel Mendoza con Zero Spam (`cliente.html`), Salesforce CRM para Carlos (`operador.html`) y WhatsApp interactivo (`miguel.html`).
