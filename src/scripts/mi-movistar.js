  ...
  handleAction(actionKey) {
    ...
    switch (actionKey) {
      case 'nbo-offer':
        ...
        setTimeout(() => {
          this.addBotMessage(`
            <p>Hola <strong>Miguel</strong>. Analicé tus consumos en tiempo real: este mes has realizado 3 recargas adicionales sumando <strong>S/ 179.80</strong>.</p>
      ...
      case 'bill-shock-expl':
        ...
        setTimeout(() => {
          this.addBotMessage(`
            <p>¡Tranquila Miguel! Nuestra arquitectura <strong>CSR-RAG</strong> valida matemáticamente cada céntimo. No hay cobros duplicados:</p>
