/* ==========================================================================
   WHATSAPP SIMULATOR ENGINE - VALERIA MENDOZA (TAP-TO-ADVANCE IMMERSIVE)
   ========================================================================== */
...
class WhatsAppValeriaSimulator {
  constructor() {
  ...
  init() {
    ...
    this.renderStep1();
    console.log('📱 WhatsApp Valeria Simulator (Tap-to-Advance) initialized.');
  }
  ...
  renderStep1() {
    ...
    this.chatBody.innerHTML = `
      ...
      <div class="wa-bubble incoming">
        <p>Hola <strong>Valeria</strong> <i data-lucide="map-pin" style="width: 13px; display: inline-block; color: #019DF4; vertical-align: -1px;"></i>. Notamos que agotaste tus 20 GB en tu viaje a Arequipa y llevas gastando <strong>S/ 179.80</strong> en paquetes adicionales este mes.</p>
  ...
  /* --- PASO 2: DUDA DE VALERIA (Pregunta de Prorrateo) --- */
  renderStep2() {
    this.renderStep1();
    
    // Inyectar duda de Valeria
  ...
  renderStep3() {
    ...
    botResponse.innerHTML = `
      <p>¡Para nada Valeria! En Movistar somos 100% transparentes. Aquí tienes el desglose exacto de tu transición:</p>
  ...
  renderStep4() {
    ...
    botSuccess.innerHTML = `
      <p>🎉 <strong>¡Felicitaciones Valeria!</strong> Tu plan Movistar Total ya está activo en tu línea móvil y tu orden de fibra ha sido emitida al back-office.</p>
  ...
  startAutoPlay() {
    ...
    setTimeout(() => {
      this.setTyping(true, 'Valeria está escribiendo...');
      setTimeout(() => {
        this.goToStep(2);
