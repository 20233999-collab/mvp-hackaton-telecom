...
export class ViewManager {
  ...
  renderPhase1() {
    // CX Panel (Valeria)
    this.cxBadgeTitle.innerText = 'Valeria Mendoza (Cliente)';
    ...
    this.chatArea.innerHTML = `
      <div class="chat-bubble bot fade-in" id="msg1_bot">
        <p>Hola <strong>Valeria</strong> <i data-lucide="map-pin" style="width: 13px; display: inline-block; color: var(--movistar-blue); vertical-align: -1px;"></i>. Notamos que agotaste tus 20 GB en tu viaje a Arequipa y llevas gastando <strong>S/ 179.80</strong> en paquetes sueltos.</p>
    ...
    this.customerStatsGrid.innerHTML = `
      <div class="stat-item">
        ...
        <span class="stat-value">Valeria Mendoza</span>
      </div>
      <div class="stat-item">
    ...
    this.whisperSpeech.innerText = `"Valeria, no te preocupes por el prorrateo: en tu primer recibo solo se incluirán S/ 15.00 correspondientes a los días de transición y luego pagarás tus S/ 139.90 fijos netos."`;
  ...
  renderPhase3() {
    // CX Panel (Valeria - Recibo Inteligente)
    this.cxBadgeTitle.innerText = 'Valeria Mendoza (Cliente)';
    ...
    this.chatArea.innerHTML = `
      ...
      <div class="chat-bubble bot fade-in" style="margin-top: 6px;">
        <p>¡Hola <strong>Valeria</strong>! No te preocupes, no es un cobro indebido. Tu tarifa fija es <strong>S/ 139.90</strong>. Los <strong>S/ 15.00</strong> son únicamente los días proporcionales de transición antes de tu corte.</p>
    ...
    this.whisperSpeech.innerHTML = `
      <strong>Cliente:</strong> Valeria Mendoza • <strong>Motivo:</strong> Consulta de Prorrateo (+S/15.00).<br>
